    ...
    types: [
      {
        ...
        originalPrice: '₹5,000',
        description:
          'Introduction to basic healing techniques and energy fundamentals. Perfect for beginners exploring healing practices.',
        includes: [
          'Basic healing introduction',
          'Energy awareness training',
          'Foundational healing techniques',
          'Initial guidance',
      ...
      },
      {
        ...
        description:
          'Comprehensive 30-day healing program focused on aligning and balancing all seven chakras with supportive energy work.',
        includes: [
          'Seven chakra alignment sessions',
          'Supportive chakra healing',
          '30-day healing program',
          'Energy balancing practices',
          'Daily guidance and support',
          'Chakra maintenance techniques',
      ...
      },
      {
        ...
        description:
          'Specialized 30-day healing program addressing specific health concerns and relationship issues through targeted energy work.',
        includes: [
          'Specialized healing for health concerns',
          'Relationship healing focus',
          '30-day comprehensive program',
          'Personalized energy protocols',
