...
export const marmaTherapyData: HealingServiceData = {
  ...
  sessions: {
    title: 'Marma Therapy Sessions',
    types: [
      {
        name: 'Full Body Marma Treatment',
        duration: '90 minutes',
        description: 'Complete marma point activation and energy balancing.',
        price: '₹3,500',
        includes: [
          'Full marma assessment',
          'Complete body marma activation',
          'Energy balancing and prana restoration',
          'Herbal oil application',
          'Post-treatment guidance',
        ],
      },
      {
        name: 'Head & Neck Marma',
        duration: '60 minutes',
        description: 'Focus on head marmas for mental clarity and relaxation.',
        price: '₹2,000',
        includes: [
          'Head marma assessment',
          'Cranial marma activation',
          'Mental clarity enhancement',
          'Tension release',
        ],
      },
      {
        name: 'Lower Body Marma',
        duration: '60 minutes',
        description: 'Treatment for legs, joints, and grounding marma points.',
        price: '₹2,500',
        includes: [
          'Lower body assessment',
          'Joint marma activation',
          'Grounding energy work',
          'Mobility enhancement',
        ],
      },
      {
        name: 'Marma & Abhyanga Combo',
        duration: '120 minutes',
        description: 'Oil massage combined with marma point therapy.',
        price: '₹4,500',
        includes: [
          'Full body abhyanga massage',
          'Targeted marma activation',
          'Energy integration',
