      ...
      sessions={[
        {
          ...
          duration: '7 days',
          description: 'Introduction to meditation-based tantric healing and foundational practices.',
          price: '₹2,100',
          originalPrice: '₹2,100',
          includes: [
        ...
        },
        {
          ...
          description: 'Advanced tantric sadhna combining divine masculine and feminine energies.',
          includes: [
        ...
        },
        {
          ...
          description: 'Master-level training in complete tantric philosophy and advanced spiritual practices.',
          includes: [
